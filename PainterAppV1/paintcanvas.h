...
public:
    ...
    void drawRect(const QPoint& _startPoint, const QPoint& _endPoint, bool _elipse = false);
    void drawLine(const QPoint &_startPoint, const QPoint &_endPoint);
signals:

public slots:
private:
    void drawLineTo(const QPoint &endPoint);
    QPoint drawLineTo(const QPoint &_lastPoint ,const QPoint &endPoint);
